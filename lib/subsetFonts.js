  ...
  if (subsetLocalFont) {
    ...
    for (const item of htmlAssetTextsWithProps) {
      for (const fontUsage of item.fontUsages) {
        ...
        console.log('!!! line 379 font url', fontUsage.fontUrl)
        ...
        for (const format of formats) {
          ...
          console.log('!!! line 388 font props', fontUsage.props, fontUsage.text, `${getGoogleFontSubsetCssUrl(
            fontUsage.props,
            fontUsage.text
          )}&format=${format}`)
  ...
  for (const {
    ...
    for (const fontUsage of fontUsages) {
      if (fontUsage.subsets) {
        ...
        console.log('!!! line 845 character sets', JSON.stringify(characterSet))
